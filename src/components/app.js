...
const fightPockets = [
  [
    ...
    "10 bridge parts",
    666,
    "/images/adventureimages/smutorc_pervert.gif",
  ],
  [
    "Modern Zmobie",
    "-5 Evil (Alcove)",
    235,
    "/images/adventureimages/modernzombie.gif",
  ],
  [
    "Harem Girl",
    "YR for outfit",
    299,
    "/images/adventureimages/kg_haremgirl.gif",
  ],
  [
    "Mountain Man",
    "YR for 2 of each ore",
    565,
    "/images/adventureimages/mountainman.gif",
  ],
  [
    "Green Ops Soldier",
    "Smoke bomb, olfact",
    589,
    "/images/adventureimages/warhipgr.gif",
  ],
  ...
  [
    ...
    "Pufferfish Spine",
    363,
    "/images/adventureimages/pufferfish.gif",
  ],
  [
    "War Hippy (space) cadet",
    "YR for Hippy Outfit",
    443,
    "/images/adventureimages/warhipb.gif",
  ],
  [
    "War Pledge",
    "YR for Frat Outfit",
    568,
    "/images/adventureimages/fratboy.gif",
  ],
];

const camelsToe = [
  "Camel's Toe",
  "2 stars/lines, olfact",
  317,
  "/images/adventureimages/cameltoe.gif",
];
const skinflute = [
  "Skinflute",
  "2 stars/lines, olfact",
  383,
  "/images/adventureimages/skinflute.gif",
];
const blooper = [
  "Blooper",
  "White Pixel, olfact",
  250,
  "/images/adventureimages/squid.gif",
];
...
const bellPockets = [
  [
    ...
    "YR source",
    517,
    "/images/adventureimages/ccs_daughter.gif",
  ],
  [
    "Uncanny desk bell",
    "3 eldritch effluvium",
    590,
    "/images/adventureimages/ccs_tentacle.gif",
  ],
  [
    "Nasty desk bell",
    "Goat cheese, milk",
    653,
    "/images/adventureimages/ccs_disciple.gif",
  ],
  [
    "Greasy desk bell",
    "Star chart, 2 stars/lines",
    533,
    "/images/adventureimages/ccs_astrologer.gif",
  ],
];
...
const buffPockets = [
  ...
  [
    ...
    "Tomorrow, +666% stats",
    121,
    "/images/itemimages/yeg_blessing.gif",
  ],
  ["Hand soap", "+200% spell dmg", 177, "/images/itemimages/yeg_sigils.gif"],
  [
    "Medieval Mage Mayhem (60)",
    "+50% weapon/+100% spell dmg",
    617,
    "/images/itemimages/swords.gif",
  ],
...
const yegPockets = [
  ...
  [
    ...
    "Full HP restore",
    642,
    "/images/itemimages/yeg_sewingkit.gif",
  ],
  [
    "Stationery",
    "Hearty messages",
    130,
    "/images/itemimages/yeg_stationery.gif",
  ],
  [
    "Toothbrush",
    "Weapon dmg potion",
    284,
    "/images/itemimages/yeg_toothbrush.gif",
  ],
];
...
const aftercoreItemPockets = [
  [
    ...
    "Meat or fight scary pirate",
    600,
    "/images/itemimages/pieceof13.gif",
  ],
  [
    "Candy crayons",
    "Increased stat from food",
    87,
    "/images/itemimages/candycrayons.gif",
  ],
  [
    "Dubious peppermint",
    "Makes numberwang",
    627,
    "/images/itemimages/candy.gif",
  ],
  ...
  [
    ...
    "Makes honey gear",
    28,
    "/images/itemimages/honeyglob.gif",
  ],
  [
    "Chocolate seal-clubbing club",
    "+adv for Seal Clubbers",
    381,
    "/images/itemimages/choc1.gif",
  ],
  [
    "Chocolate turtle totem",
    "+adv for Turtle Tamers",
    477,
    "/images/itemimages/choc2.gif",
  ],
  [
    "Chocolate pasta spoon",
    "+adv for Pastamancers",
    654,
    "/images/itemimages/choc3.gif",
  ],
  [
    "Chocolate saucepan",
    "+adv for Saucerors",
    438,
    "/images/itemimages/choc4.gif",
  ],
  [
    "Chocolate disco ball",
    "+adv for Disco Bandits",
    430,
    "/images/itemimages/choc5.gif",
  ],
  [
    "Chocolate stolen accordion",
    "+adv for Accordion Thieves",
    189,
    "/images/itemimages/choc6.gif",
  ],
  [
    "Handful of Bees",
    "Combat item @ 100 dmg/round",
    187,
    "/images/itemimages/bees.gif",
  ],
];
...
const App = () => {
  ...
  if (ashProperties?.inAftercore === "true") {
    const localBellPockets = [
      ...bellPockets,
      [
        "Frost-rimed desk bell",
        "Cold wads, nuggets, powder",
        587,
        "/images/adventureimages/ccs_herald.gif",
      ],
    ];
    return (
      <div id="preact_root">
  ...
  const localItemPockets =
    ashProperties?.lastUsername?.toLowerCase() !== "accodorian"
      ? itemPockets
      : [
          ...itemPockets,
          [
            ...
            "Oil of slipperiness",
            570,
            "/images/itemimages/olive.gif",
          ],
        ];
  const ascensions = ashProperties?.knownAscensions ?? 0;
  const localFightPockets = [
    ...fightPockets,
    ascensions % 2 == 0 ? skinflute : camelsToe,
    blooper,
  ];
  return (
    <div id="preact_root">
